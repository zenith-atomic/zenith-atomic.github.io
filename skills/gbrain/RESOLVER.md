...
| "Scrape this", "crawl this site", "fetch this page" | `skills/idea-ingest/SKILL.md` (use local firecrawl script) |
| Video, audio, PDF, book, YouTube, screenshot | `skills/media-ingest/SKILL.md` |
| Meeting transcript received | `skills/meeting-ingestion/SKILL.md` |
| Generic "ingest this" (auto-routes to above) | `skills/ingest/SKILL.md` |

> **Web scraping tool:** `~/.openclaw/workspace/scripts/firecrawl.py`
> Self-hosted, no API key. Subcommands: `scrape`, `batch`, `crawl`.
